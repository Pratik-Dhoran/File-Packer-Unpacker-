...
class Packing
{
    ...
    {
        System.out.println("------------------------------------------------");
        System.out.println("---------- Pratik's Packer Unpacker ----------");
        System.out.println("------------------------------------------------");
        ...
        if(bret == true)
        {
            ...
            for(int i = 0; i < Arr.length; i++)
            {
                ...
                //To Add extra white spaces at the end of header
                for(int j = Header.length(); j < 100; j++)
                {
                    Header = Header + " ";
                }

                //To Convert string header into byte array
                byte hArr[] = Header.getBytes();

                //To Write header into packed file
                fcombine.write(hArr,0,100);

                //To read the file from duirectory
                FileInputStream fiobj = new FileInputStream(Arr[i]);

                //To write the data into packed file after header
            ...
            System.out.println("------------------------------------------------");
            System.out.println("Thank you for using Pratik's Packer Unpacker");
            System.out.println("------------------------------------------------");
        }
        else 
        {
